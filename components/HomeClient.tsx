...
import HomeNewsPreview, { HomeNewsPreviewProps } from "@/components/HomeNewsPreview"
...
interface HomeClientProps {
  latestEntries: HomeNewsPreviewProps["latestEntries"]
...
export default function HomeClient({ latestEntries, upcomingShows, galleryImages }: HomeClientProps) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <HomeNewsPreview latestEntries={latestEntries} />
